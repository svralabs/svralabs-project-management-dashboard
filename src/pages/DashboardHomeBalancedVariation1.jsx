...
export default function DashboardHomeBalancedVariation1() {
...
<div className="flex items-center justify-between pt-6 border-t border-neutral-800"><div className="flex flex-wrap gap-3">
<div className="flex items-center gap-2 bg-surface-bright px-4 py-2 rounded-full border border-neutral-700/50">
<span className="w-2.5 h-2.5 rounded-full bg-white"></span>
<span className="text-[10px] uppercase text-white font-bold tracking-wider">Resources</span>
</div>
<div className="flex items-center gap-2 bg-surface-bright px-4 py-2 rounded-full border border-neutral-700/50">
<span className="w-2.5 h-2.5 rounded-full bg-[#C4F82A]"></span>
<span className="text-[10px] uppercase text-white font-bold tracking-wider">Valid</span>
</div>
<div className="flex items-center gap-2 bg-surface-bright px-4 py-2 rounded-full border border-neutral-700/50">
<span className="w-2.5 h-2.5 rounded-full bg-[#FF7A00]"></span>
<span className="text-[10px] uppercase text-white font-bold tracking-wider">Invalid</span>
</div>
</div>
<div className="bg-surface-bright px-4 py-2 rounded-full border border-neutral-700/50">
<span className="text-[10px] font-black text-white tabular-nums uppercase tracking-wider">Total: 1,012</span>
</div></div></div>
</div>
...
<div className="flex items-center justify-between mb-8"><div className="flex flex-wrap gap-2">
<div className="flex items-center gap-2 bg-surface-bright px-3 py-1.5 rounded-full border border-neutral-700/50">
<span className="w-2 h-2 rounded-full bg-white"></span>
<span className="text-[9px] uppercase text-white font-bold">Customer</span>
</div>
<div className="flex items-center gap-2 bg-surface-bright px-3 py-1.5 rounded-full border border-neutral-700/50">
<span className="w-2 h-2 rounded-full bg-[#C4F82A]"></span>
<span className="text-[9px] uppercase text-white font-bold">Product</span>
</div>
<div className="flex items-center gap-2 bg-surface-bright px-3 py-1.5 rounded-full border border-neutral-700/50">
<span className="w-2 h-2 rounded-full bg-[#FF7A00]"></span>
<span className="text-[9px] uppercase text-white font-bold">Web</span>
</div>
</div>
<div className="bg-surface-bright px-4 py-1.5 rounded-full border border-neutral-700/50">
<span className="text-[10px] font-black text-white tabular-nums uppercase">Total: 284</span>
</div></div>
