...
export default function DashboardHomeTechnicalHighContrast1() {
...
<header className="fixed top-0 left-0 w-full z-50 bg-surface flex justify-between items-center px-gutter h-16 border-b border-white/10">
...
<a className="text-on-surface-variant font-label-sm text-label-sm cursor-pointer active:scale-95 hover:bg-surface-variant transition-colors" href="#">Stats</a>
<a className="text-on-surface-variant font-label-sm text-label-sm cursor-pointer active:scale-95 hover:bg-surface-variant transition-colors" href="#">Tree</a>
</div>
<div className="flex items-center gap-4">
<span className="material-symbols-outlined cursor-pointer active:scale-95 p-2 rounded-full hover:bg-surface-variant text-on-surface-variant">notifications</span>
<div className="w-8 h-8 rounded-full overflow-hidden border border-white/10">
<img alt="User profile" className="w-full h-full object-cover" data-alt="A close-up, high-detail professional headshot of a software engineer in a dark, tech-oriented studio. The lighting is dramatic and moody, utilizing deep shadows and subtle neon lime rim lighting to match the UI aesthetic. The background is a clean, dark onyx grey. The overall mood is serious, competent, and modern." src="https://lh3.googleusercontent.com/aida-public/AB6AXuCXATJdZd_AmTpvsqpWC7n0EGKqhkpgliNhRjpxYBQBLTzO0M2iit0EFNj30e71pBd0Hrkv6nbU6JzK1Ote8_dckba7fDi9mGDkgDx1FmjUzR2r0m8nvsP6jDJfRNpJrhG0odWwpGyDJXYZiiKFvkdHwGMy-SUClO5yEtKFOxJES2duvSdwB_bSst6bds6iYrm4nBhXCArEyv__3OcFxyN_bf7ZuYhngyJEos69KNb9Hbkm8yzw2VaU-mXFnrkSzxD_xtMDIYic9w"/>
</div>
</div>
</div>
</header>

<aside className="fixed left-0 top-16 hidden md:flex flex-col items-center py-gutter gap-gap bg-surface-container-low h-[calc(100vh-64px)] w-20 border-r border-white/5 transition-all duration-200">
...
<div className="flex flex-col items-center gap-1 w-full text-on-surface-variant hover:text-primary hover:bg-white/5 py-2 cursor-pointer transition-all">
...
<div className="mt-auto flex flex-col items-center gap-1 w-full text-on-surface-variant hover:text-primary hover:bg-white/5 py-2 cursor-pointer transition-all">
...
<p className="font-body-md text-body-md text-on-surface-variant mt-1 opacity-70">Global Analytics Environment / v2.0</p>
</div>
<div className="flex gap-3 overflow-x-auto pb-2">
<div className="px-4 py-2 bg-surface-container-high rounded-full flex items-center gap-2 cursor-pointer hover:bg-surface-variant transition-colors group">
...
<div className="px-4 py-2 bg-secondary rounded-full flex items-center gap-2 cursor-pointer active:scale-95 transition-all">
...
<div className="md:col-span-4 surface-card p-padding rounded-lg flex flex-col justify-between h-[340px]">
<div>
...
<div className="md:col-span-8 surface-card p-padding rounded-lg flex flex-col h-[340px]">
...
<div className="text-secondary font-bold text-lg">94.1</div>
</div>
<div>
<span className="font-label-sm text-label-sm text-on-surface-variant">GROWTH</span>
<div className="text-tertiary-fixed-dim font-bold text-lg">+12.4%</div>
</div>
</div>
</div>
...
<div className="md:col-span-7 surface-card p-padding rounded-lg flex flex-col min-h-[400px]">
...
<span className="px-3 py-1 bg-white text-black font-label-sm text-label-sm rounded-full font-bold">Total: 1,012</span>
</div>
...
<div className="md:col-span-5 surface-card p-padding rounded-lg flex flex-col min-h-[400px]">
...
<div className="surface-card p-5 rounded-lg border border-white/5">
