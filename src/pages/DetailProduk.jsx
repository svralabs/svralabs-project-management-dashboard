      ...
      <section className="flex-1 px-margin py-xl bg-surface rounded-t-[24px] -mt-6 relative z-10">
        ...
        <div className="flex items-center gap-sm mb-xl py-sm">
          ...
          <div className="flex flex-col">
            <span className="text-label-caps font-label-caps text-on-surface-variant">Event: {product.event}</span>
            <span className="text-label-caps font-label-caps text-error-text">Berakhir {product.eventDaysLeft} hari lagi</span>
          </div>
        </div>
